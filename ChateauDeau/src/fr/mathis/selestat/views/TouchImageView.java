...
import static fr.mathis.selestat.views.TouchImageView.State.ANIMATE_ZOOM;
import static fr.mathis.selestat.views.TouchImageView.State.DRAG;
import static fr.mathis.selestat.views.TouchImageView.State.FLING;
import static fr.mathis.selestat.views.TouchImageView.State.NONE;
import static fr.mathis.selestat.views.TouchImageView.State.ZOOM;
...
public class TouchImageView extends ImageView {
	...
	/**
	 * After setting image, a value of true means the new image should maintain the zoom of the previous image. False means the image should be resized within the view. Defaults value is true.
	 * 
	 * @param maintainZoom
	 */
